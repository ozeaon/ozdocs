...
- [kanban.md](kanban.md). The 13-column board on Monday. What each column means, who owns it, and how design tickets translate into dev tickets.
...
Design ideation and signoff happen in columns 1 to 6. That work is then translated into granular dev tickets which move through columns 7 to 13. Anything that changes after a ticket reaches Design Done needs a change request. Internal feedback goes to BA/PM, who triage before anything reaches dev or design. External bugs come in via the bug report form.
